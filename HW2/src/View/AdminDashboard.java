...
public class AdminDashboard extends Stage{
    ...
    public AdminDashboard() throws IOException {
        ...
        FXMLLoader CreateAccountLoader = new FXMLLoader(getClass().getResource("AdminFXML/createaccount2.fxml"));
        Parent AccountRoot = CreateAccountLoader.load();     
        CreateAccountScene = new Scene(AccountRoot);
