...
public class UsersManagmentController implements Initializable {
    ...
    public static Stage updateStageaccount;
    ////////////////////////////////////////////////////////////////////////////////////////////
    @FXML
    ...
    private void updateSelectedUser(ActionEvent event) throws IOException {
        ...
        updateStageaccount = new Stage();
        updateStageaccount.setScene(updateUserScene);
        updateStageaccount.setTitle("Update user " + selectedUserToUpdate.getUsername() );
        updateStageaccount.show();
        }
    }
